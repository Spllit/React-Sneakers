            ...
            <div className='header__container'>
                ...
                <nav className='header__nav-container nav'>
                    <ul className='header__nav nav__list'>
                        <li className='header__bag nav__item'>
                            <button className='nav__btn' onClick={props.setBagisOpen}>
                                ...
                                <span className='nav__coast'>1205</span>
                                <span>руб</span>
                            </button>
                        </li>
                        <li className='header__favorite nav__item'>
                            <Link to='/favorites'>
                        ...
                        <li className='header__profile nav__item'>
                            <Link to='/profile'>
                                <button className='nav__btn'>
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
